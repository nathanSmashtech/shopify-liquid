<script>
      (function() {
        class CtaOp1ItemSubTbyb extends HTMLElement {
          constructor() {
            super();
            this.button = this.querySelector('.cta-op-1item-sub-tbyb');
          }
        ...
        customElements.define('cta-op-1item-sub-tbyb', CtaOp1ItemSubTbyb);
      })();
    </script>