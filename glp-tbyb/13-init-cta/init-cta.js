<script>
      (function() {
        class CtaGlp1ItemSubTbyb extends HTMLElement {
          constructor() {
            super();
            this.button = this.querySelector('.cta-glp-1item-sub-tbyb');
          }
        ...
        customElements.define('cta-glp-1item-sub-tbyb', CtaGlp1ItemSubTbyb);
      })();
    </script>